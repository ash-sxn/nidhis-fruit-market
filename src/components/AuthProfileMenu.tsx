  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="font-medium text-saffron">{profile?.username || "Profile"}</span>
      </button>
      {dropdown && (
        <div className="absolute right-0 mt-2 w-44 bg-white border rounded-lg shadow-xl z-50 py-2">
          <div className="px-4 py-2 text-neutral-700 font-semibold">{profile?.username}</div>
